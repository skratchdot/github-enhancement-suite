...
exports.name = 'Github Pages Link';
exports.description = 'If a repository has a gh-pages branch, then this will add links to the Github Page, as well as the gh-page source code.';
